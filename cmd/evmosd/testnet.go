...
import (
	...
	"github.com/justcharlz/dhives/crypto/hd"
	evmoskr "github.com/justcharlz/dhives/crypto/keyring"
	"github.com/justcharlz/dhives/server/config"
	srvflags "github.com/justcharlz/dhives/server/flags"
	"github.com/justcharlz/dhives/testutil/network"
...
Example:
	dhivesd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "dhivesd", "Home directory of the node's daemon configuration")
...
Example:
	dhivesd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
