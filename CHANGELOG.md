...
- (testnet) [#2826](https://github.com/evmos/evmos/pull/2826) Fix command `dhivesd testnet init-files` for validator_address is error.
...
- (testnet) [#1864](https://github.com/evmos/evmos/pull/1864) Add `--base-fee` and `--min-gas-price` flags to the command `dhivesd testnet init-files`.
...
- (testnet) [#1857](https://github.com/evmos/evmos/pull/1857) Remove the crisis module causing an error when using the `dhivesd testnet init-files` command.
...
- (cli) [#1647](https://github.com/evmos/evmos/pull/1647) Update defaults on `dhivesd start` flags.
...
- (tests) [#1678](https://github.com/evmos/evmos/pull/1678) Fix e2e tests after recent changes to `dhivesd start` default flags.
...
- (cli) [#1121](https://github.com/evmos/evmos/pull/1121) Fix `dhivesd version` to show either tag or last commit.
